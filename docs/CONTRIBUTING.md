...
1. Check the [issues](https://github.com/ded-furby/ruock/issues) to see if it's already been reported.
...
Got an idea to make Ruock better? Awesome, let's discuss it!

Here's how to go about it:

1. Check [issues](https://github.com/ded-furby/ruock/issues) and [board](https://github.com/ded-furby/ruock/projects?query=is%3Aopen) to see if it's already on the radar.
2. If not, open a new issue with:
...
All code submissions are reviewed before being merged - at the moment that's just me (@ded-furby 👋).
...
Thanks again for considering a contribution to Ruock! 🖤
