            ...
            VStack(alignment: .leading) {
                ...
                SettingsSectionView(title: L10n.more) {
                    SettingsLinkRowView(
                        ...
                        url: "https://github.com/ded-furby/ruock/releases/tag/\(AppInfoHelper.appVersion)"
                    )
                    
                    SettingsLinkRowView(
                        title: L10n.contribute,
                        url: "https://github.com/ded-furby/ruock"
                    )
                    
                    SettingsLinkRowView(
                        title: L10n.reportBug,
                        url: "https://github.com/ded-furby/ruock/issues",
                        showDivider: false
                    )
                }
