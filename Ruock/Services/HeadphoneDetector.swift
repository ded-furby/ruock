...
/// and automatically enables/disables Ruock accordingly.
final class HeadphoneDetector {
    ...
    private func handleHeadphoneConnected() {
        ...
        if !AppEngine.shared.isEnabled() {
            Logger.audio.info("HeadphoneDetector: Headphone connected, enabling Ruock")
    ...
    private func handleHeadphoneDisconnected() {
        ...
        if AppEngine.shared.isEnabled() {
            Logger.audio.info("HeadphoneDetector: Headphone disconnected, disabling Ruock")
